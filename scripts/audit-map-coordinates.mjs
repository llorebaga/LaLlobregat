...
const aliases = {
  ...
  "la floresta": { query: "la Floresta, Sant Cugat del Vallès", label: "La Floresta" },
  ...
  "sant salvador del vendrell": { query: "Auditori Pau Casals, Sant Salvador, El Vendrell", label: "Sant Salvador del Vendrell" },
